 ...
 * @author ahmed.elemam
 */
public class Cparameterfieldtype implements Converter{
    
      @EJB
    private ParamterFieldTypeFacadeLocal parameterTypeFacade;
 ...
 @Override
  ...
  if (!(value instanceof ParamterFieldType)) {
                return null;
            }
 
           String s =  String.valueOf(((Entities.ParamterFieldType) value).getId());
